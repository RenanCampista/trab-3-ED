...
def parse_args():
    # cria um parser de argumentos, ou seja, um objeto que sabe como ler os argumentos passados na linha de comando
...
def load_index(output_file):
    ...
    # o primeiro numero do arquivo eh o numero de palavras distintas no indice
