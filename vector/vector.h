 ...
 * @param v Ponteiro para a estrutura do Vector.
 * @param comp_fn Função de comparação.
*/
void vector_sort(Vector *v, int (*comp_fn)(data_type, data_type));
 ...
 * @param comp_fn Função de comparação.
 * @return O elemento encontrado. Caso não encontre, retorna NULL.
*/
data_type vector_search(Vector *v, data_type val, int (*comp_fn)(data_type, data_type));
